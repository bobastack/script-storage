...
Promo = {
    ...
    "Get Ethh.lol",
    "Ethh.lol Best Lock",
    "lowkey im glazing ethh.lol",
    "Ethh.lol aint dectected",
    "Ethh.lol Keyless",
    "Ethh.lol Best AutoStomp",
    "Ethh.lol Best Animations"
}
        ...
        elseif Config.enabled and (Config.spyOnMyself == true or p ~= player) then
            ...
            if hidden and Config.enabled then
                if Config.public then
                    saymsg:FireServer((Config.publicItalics and "/me " or '') .. "{Ethh.lol} [" .. p.Name .. "]: " .. msg, "All")
                else
...
WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Ethh.lol | %s fps | %s ms'):format(
        math.floor(FPS),
        ping
    ))
end)
